...
>    - [add additional Agenda items](./before/intro#adding-to-the-agenda) before the Meeting starts.
> 1. When the Meeting starts, you can:
>    - [Make Comments](./during/intro#comments).
>    - [Reply to Comments](./during/intro#replies).
>    - [Vote](./during/voting/intro) on Motions.
> 1. When the [Meeting is over](./after/intro), you can:
>    - Print the Minutes and/or full Transcript.
>    - Access the Meeting from the [Archives](/docs/started/Group%20Actions/intro#archives).
