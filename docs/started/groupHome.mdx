...
If you don't want to start a [**Group Discussion**](/docs/discussions/starting/starting), and only want to send a _'one off'_ email to members of your Group, you can do it from the Group Home Page.
